...
public class WebcamPanel extends JPanel implements WebcamListener, PropertyChangeListener {
	 ...
	 */
	private static final double MAX_FREQUENCY = 100; // 50 frames per second
	 ...
	 */
	private double frequency = 0.5; // FPS 5 -> 10
	 ...
	 */
	private boolean frequencyLimit = true;
	 ...
	 * Display image size.
	 */
	private boolean imageSizeDisplayed = true;
