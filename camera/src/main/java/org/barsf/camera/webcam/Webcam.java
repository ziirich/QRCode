...
import org.barsf.camera.webcam.WebcamDevice.Configurable;
import org.barsf.camera.webcam.WebcamUpdater.DefaultDelayCalculator;
import org.barsf.camera.webcam.WebcamUpdater.DelayCalculator;
import org.barsf.camera.ds.buildin.WebcamDefaultDevice;
import org.barsf.camera.ds.buildin.WebcamDefaultDriver;
import org.barsf.camera.ds.cgt.WebcamCloseTask;
import org.barsf.camera.ds.cgt.WebcamDisposeTask;
import org.barsf.camera.ds.cgt.WebcamGetBufferTask;
import org.barsf.camera.ds.cgt.WebcamGetImageTask;
import org.barsf.camera.ds.cgt.WebcamOpenTask;
import org.barsf.camera.ds.cgt.WebcamReadBufferTask;
...
public class Webcam {
	...
	public void setViewSize(Dimension size) {
		...
		if (!ok) {
			...
			for (Dimension d : predefined) {
				sb.append("predefined-[").append(d.width).append("x").append(d.height).append("] ");
			}
			for (Dimension d : custom) {
